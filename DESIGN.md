...
- Runtime editor: one instance-directory field with inline validation. Application Manager readiness is shown as
  read-only status; address and credential controls are intentionally absent because MCP discovers them from the
  selected instance.
